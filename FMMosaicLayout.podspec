Pod::Spec.new do |s|
  ...
  s.screenshots      = ["http://fmitech.github.io/FMMosaicLayout/Screenshots/portrait-1.png",
                        ...
                        "http://fmitech.github.io/FMMosaicLayout/Screenshots/fmmosaiclayout.gif"]
  s.license          = 'MIT'
  s.author           = { "JVillella" => "julian.villella@hotmail.com" }
  s.source           = { :git => "https://github.com/gooulin/MosaicLayoutWithHYBScrollView.git", :tag => s.version.to_s }

  s.platform     = :ios, '7.0'
  s.requires_arc = true

  s.source_files = 'FMMosaicLayout'
  s.resources    = 'FMMosaicLayout/Example.storyboard'
end
